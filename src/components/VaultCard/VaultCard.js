    ...
    <div className="vaultWrapper bg-white">
      ...
      <div className="d-flex flex-column gap-3">
        <div className="row justify-content-between gap-2 m-0">
            ...
            <img src={EthPool} alt='eth_pool' />
            <span className="poolTitle p-0">{pool}</span></div>
            <span className="aprTitle p-0">{apr}<span className="aprText ml-2">APR</span></span>
        </div>
        <div className="row justify-content-between gap-2 m-0">
           ...
           <a className="btn filled-btn d-flex align-items-center" href={link} target='_blank' rel='noreferrer'>Supply  <img src={rightArrow} alt="" className="ml-3"/></a>
