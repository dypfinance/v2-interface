  ...
  return (
    <div className="coin-card bg-white p-3 d-flex align-items-start position-relative">
      ...
      <div>
        ...
        <div>
        <p className="text-secondary mb-0" style={{fontSize: '12px', fontWeight: '400'}}>{title}</p>
      ...
      <img src={coinCardIcon} alt="" />
        ...
        <p className="mb-0 pt-1 text-secondary" style={{fontSize: '10px', fontWeight: '400'}}>{description}</p>
      </div>
    </div>
  );
};
