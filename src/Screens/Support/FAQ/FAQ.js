...
const FAQ = () => {
  ...
  const stake = [
    {
      ...
      content: '<p class="mb-0 faq-content">An innovative metaverse platform that redefines the gaming industry and digital currency services. Platform utilizes cutting-edge blockchain technology, giving an unique experience.</p>',
      id: 'collapseOne',
      heading: 'headingOne'
    },
    {
      title: 'What is DYP Staking?',
      content: '<p class="mb-0 faq-content">DYP Staking is a product that allows users to deposit DYP tokens into an audited staking contract to earn rewards. The staking pools integrate the REINVEST function allowing users to automatically add their daily rewards back into the staking pool.</p>',
      id: 'collapseTwo',
      heading: 'headingTwo'
    },
    {
    ...
    },
    {
      ...
      content: '<p class="mb-0 faq-content">Currently, DYP offers staking on ETH, BNB and AVAX.</p>',
      id: 'collapseFour',
      heading: 'headingFour'
    },
    {
      title: 'What Lock Times are available for DYP staking?',
      content: '<p class="mb-0 faq-content">Currently, DYP offers staking with no lock period, 90 days, and 180 days.</p>',
      id: 'collapseFive',
      heading: 'headingFive'
    },
    {
      title: 'How are rewards distributed from staking?',
      content: '<p class="mb-0 faq-content">The rewards are shown in real time on the DYP dApp and will need to be claimed in order to transfer the rewards to the user’s wallet.</p>',
      id: 'collapseSix',
      heading: 'headingSix'
    },
    {
      title: 'ow does DYP generate the staking rewards? ',
      content: '<p class="mb-0 faq-content">The rewards are generated based on Proof of Stake concept. Proof of Stake (PoS) is a consensus mechanism where block validators are selected based on the number of coins they are staking. For more information about PoS you can head to the link down below: </p>',
    ...
    },
    {
      ...
      content: '<p class="mb-0 faq-content">First, check to see if the assets are locked in a pool and if the pool lock has ended. Users can withdraw their asset after the completion of the lock period. i.e., if you joined a 90-day pool you can only withdraw after the 90-day lock period is over.</p>',
      id: 'collapseNine',
      heading: 'headingNine'
    },
    {
      title: 'Will I be getting the same amount of DYP I deposited when I withdraw?',
      content: '<p class="mb-0 faq-content">Yes, you users will withdraw the same amount of DYP as deposited.</p>',
      id: 'collapseTen',
      heading: 'headingTen'
    },
    {
      title: 'Will my lock period reset if I deposit additional assets?',
      content: '<p class="mb-0 faq-content">Yes, if users add new deposits in between lock periods, the lock period resets back to 0 days. Users will need to wait for the new lock period to expire before withdrawal of assets would be possible.</p>',
      id: 'collapseEleven',
      heading: 'headingEleven'
    },
    {
      title: 'Can I still earn rewards even after my lock period ends if I do not withdraw my assets?',
      content: '<p class="mb-0 faq-content">Yes, users will continue to earn rewards even after the initial lock period ends and can earn these rewards until the contract expiry.</p>',
      id: 'collapseTwelve',
      heading: 'headingTwelve'
    },
    {
      title: 'What is APY?',
      content: '<p class="mb-0 faq-content">Annual percentage yield (APY) is a percentage that reflects the amount of money, or interest, you earn on an account over the course of one entire year.</p>',
      id: 'collapseThirteen',
      heading: 'headingThirteen'
    },
    {
      title: 'Will the APY reduce if I keep staking after my lock period ends?',
      content: '<p class="mb-0 faq-content">No, users will continue to receive their rewards based on the current APY.</p>',
      id: 'collapseFourteen',
      heading: 'headingFourteen'
    },
    {
      title: 'What is the Reinvest function?',
      content: '<p class="mb-0 faq-content">The Reinvest function allows users to reinvest their earned rewards back into the original deposited value so that they can earn more rewards with the new increase in deposited token balance. In addition, the reinvest function does NOT reset user’s lock period.</p>',
      id:  'collapseFifteen',
      heading: 'headingFifteen'
    },
    {
      title: 'Where can I take advantage of these staking pools and are there tutorials available?',
  ...
  const farming = [
    ...
    {
      title: 'Why don’t my actual rewards match with the rewards shown on the calculator?',
      content: `<p class="faq-content">
    ...
    {
      title: 'Why are the rewards not showing in my wallet after I claimed and completed the transaction?',
      content: `<p class="faq-content">
...
If the DYP price is affected by more than -2.5%, then the maximum DYP amount that does not affect the price will be swapped, with the remaining amount distributed in the next day’s rewards. After seven days, if we still have undistributed DYP rewards, the Dypius governance will vote on whether the remaining DYP will be distributed to the token holders or burned (all burned tokens are removed from circulation).
    ...
    {
      title: 'Where can I find these farming pools and are there tutorials on how to farm?',
      content: `<p class="mb-0">
                    These pools can be found on our website and tutorials are available for each of them. You can find more details down below:
                    </p>
                  <div class='row d-grid pool-container p-4'>
  ...
  const buyback = [
    ...
    {
      title: 'Where can I find these pools and are there tutorials on how to do Buyback?',
  ...
  const vault = [
    ...
    {
      title: 'Will I be getting the same amount of tokens I deposited when I withdraw?',
    ...
    {
      title: 'Where can I find the DYP Vault and are there tutorials on how to take advantage of the Vault?',
  ...
  const governance = [
    ...
    {
      title: 'Is there a history of successfully executed Governance proposals available?',
      content: `<p class="faq-content">
    ...
    {
      title: 'What happens to my locked DYP tokens used for Governance? Are they lost?',
      content: `<p class="faq-content">
    ...
    {
      title: 'Can I withdraw my DYP token used for voting before the Governance proposal ends?',
      content: `<p class="faq-content">
  ...
  const bridge = [
    ...
    {
      title: 'Why does my bridge transaction fail and it shows insanely high gas fees?',
      content: `<p class="faq-content">
...
More information about each of these features can be found on our medium article here
    ...
    {
      title: 'Do I need to hold DYP token to access the Premium Subscription of DYP Tools?',
      content: `<p class="faq-content">
      ...
      <div className="container-lg d-flex justify-content-center align-items-center flex-column py-5">
        <div className="col-6">
          ...
          <p className="text-secondary text-center">
            ...
            convallis nisi sed diam placerat, in commodo odio posuere. Aliquam
            lacus sapien
          </p>
        </div>
          ...
          <div className="row justify-content-between align-items-center">
            ...
            <FormControl sx={{ width: 200 }}  
              ...
              >
                ...
                <MenuItem key={index} value={selectItem.value}>{selectItem.title}</MenuItem>
                ))}
              </StyledSelect>
            </FormControl>
          </div>
          ...
          <div className="row flex-column">
            ...
            <div class="accordion" id="faqAccordion">
              {faqItems.map((faq, index) => (
                <FAQAccordion key={index} title={faq.title} content={faq.content} id={faq.id} heading={faq.heading} />
              ))}  
            </div>
          </div>
        </div>
