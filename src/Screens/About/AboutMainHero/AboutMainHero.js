    ...
    <div className="container-fluid about-main-hero d-flex flex-column justify-content-end">
      <div className="row justify-content-center">
        <div className="col-5">
          ...
          <p>Through our strong foundation, we aim to bring you a powerful decentralized ecosystem that faces the future. 
            <br />
            <br />
            In addition to a variety of products and services currently offered like yield farming and staking, we are constantly building and expanding our scope to include more advanced DeFi and educational tools, NFTs and even Metaverse gaming, making us accessible for both beginner and advanced users.
</p>
        </div>
        <div className="col-5 position-relative">
          ...
          <img src={painting} className='painting' alt="" style={{borderRadius: '28px'}} />
          </div>
