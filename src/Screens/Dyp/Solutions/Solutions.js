...
const Solutions = () => {
  ...
  return (
    <div className="container-fluid position-relative" id='solutions'>
        ...
        <div className="row d-grid px-5 solutions-card-container">
            {windowSize.width < 786 ?
              solutions.slice(0, solutionLength).map((solution, index) => (
        ...
        <div className="row justify-content-center my-5">
          <button onClick={loadMore} className="btn outline-btn d-flex d-lg-none justify-content-center align-items-center">
            Load More +
          </button>
        </div>
