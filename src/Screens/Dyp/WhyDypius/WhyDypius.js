...
const cards = [
  {
    ...
    description: 'Dypius offers unique solutions in the DeFi space like Anti-Manipulation so that users can benefit from even on simpliest daily operations.'
  },
  {
    title: 'Adaptability',
    description: 'Dypius prides itself in its ability to quickly adapt to the new and emerging market trends. Dypius flexibility and expertise allows for pioneering in the DeFi space in a quick and unparalleled innovative way.'
  },
  {
    title: 'Extended product catalogue',
    description: 'Dypius offers a large diversity of products on the platform that generates value to users like Farming, Staking, Vault, Buyback, CAWS NFT, DYP Governance and much more. '
  },
  {
    title: 'Market consistency',
    description: 'Dypius has a very well-known, trusted, and stable history in the DeFi market which is reflected on its outstanding statistics and users feedback.'
  },
  {
    title: 'Trusted partner',
    description: 'Dypius is proud of its growing list of trusted and secure partners and all smart contracts audited and monitored 24/7 by the best companies in the business.'
  },
  {
    title: 'Education and protection',
    description: 'Dypius help, educate, and protect every user by giving them the right information, data analytics, and new trends through our unique solutions safety measures.'
  },
]
        ...
        <img className='ring' src={require(`../../../assets/tokenCircle.png`)} />
                {windowSize.width <= 786 
                 ...
                 {cards.slice(0, 3).map((card, index) => (
                    <WhyDypCard key={index} title={card.title} description={card.description} />
                  ))}
                  </>
                  :
                  <>
