      ...
      <OutsideClickHandler onOutsideClick={() => setshowPopup(false)}>
        ...
        >
          ...
          <div className="d-flex justify-content-center">
            <MobileView>
              <a href="https://drive.google.com/file/d/1EArSD0-cSIx4M48fFaOflFHMGoKIguR9/view?usp=sharing" target="_blank" rel="noreferrer"  className={` d-flex align-items-center filled-btn btn `}>Download on mobile</a>
            </MobileView>
            <BrowserView>
